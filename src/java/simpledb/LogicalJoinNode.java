...
public class LogicalJoinNode {
   ...
   * It's the alias of the table (if no alias, the true table name).
   * */
   ...
   * It's the pure name of a field, rather that alias.field.
   * */
  ...
  /**
   * Returns a new LogicalJoinNode with the inner and outer (t1.f1 and t2.f2)
   * tables swapped.
   * */
