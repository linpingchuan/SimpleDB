 ...
 *
 * It handles <code>close</code>, <code>next</code> and <code>hasNext</code>.
...
public abstract class Operator implements DbIterator {
  ...
  /**
   * Returns the children DbIterators of this operator. If there is only one
   * child, return an array of only one element. For join operators, the order
   * of the children is not important. But they should be consistent among
   * multiple calls.
   * */
   ...
   * 
   * @param children The DbIterators which are to be set as the children(child)
   * of this operator.
   * */
  public abstract void setChildren(DbIterator[] children);

  /**
   * Returns the TupleDesc of the output tuples of this operator.
   * */
