 ...
 * able to write different log records as needed, but it is the responsibility
 * of the caller to ensure that write ahead logging and two-phase locking
...
//    });
  ...
  */
  ...
  public synchronized void logTruncate() throws IOException {
    ...
    Debug.log("TRUNCATING LOG;  WAS " + raf.length() + " BYTES ; NEW START : "
        + minLogRecord + " NEW LENGTH: " + (raf.length() - minLogRecord));
   ...
   * updated to their pre-updated state.
   * 
