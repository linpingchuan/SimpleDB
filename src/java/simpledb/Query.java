...
/**
 * Query is a wrapper class to manage the execution of queries. It takes a
 * query plan in the form of a high level DbIterator (built by initiating the
 * constructors of query plans) and runs it as a part of a specified transaction.
 */
