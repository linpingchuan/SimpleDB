...
public class Utility {
  /**
   * Returns a Type array of length len populated with Type.INT_TYPE.
   */
  ...
  /**
   * Returns a String array of length len populated with the (possibly null)
  ...
  /**
   * Returns a TupleDesc with n fields of type Type.INT_TYPE, each named
  ...
  /**
   * Returns a TupleDesc with n fields of type Type.INT_TYPE.
   */
  ...
  /**
   * Returns a Tuple with a single IntField with value n and with
  ...
  /**
   * Returns a Tuple with an IntField for every element of tupdata and
   * RecordId(HeapPageId(1, 2), 3).
   */
  ...
  /**
   * Returns a Tuple with a 'width' IntFields each with value n and with
   * RecordId(HeapPageId(1, 2), 3)
   */
  ...
  /**
   * Returns a Tuple with a 'width' IntFields with the value tupledata[i]
   * in each field.
   *
   * Do not set it's RecordId, hence do not distinguish which sort of file it
   * belongs to.
   */
