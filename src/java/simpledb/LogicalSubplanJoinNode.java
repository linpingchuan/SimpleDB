...
/**
 * A LogicalSubplanJoinNode represens the state needed of a join of a table to
 * a subplan in a LogicalQueryPlan (inherits state from {@link LogicalJoinNode}).
...
public class LogicalSubplanJoinNode extends LogicalJoinNode {
  ...
  public LogicalSubplanJoinNode(String table1, String joinField1, DbIterator sp,
      Predicate.Op pred) {
    t1Alias = table1;
  ...
  public boolean equals(Object o) {
    ...
    return (j2.t1Alias.equals(t1Alias) &&
        j2.f1PureName.equals(f1PureName) &&
