...
/**
 * A PlanCache is a helper class that can be used to store the best way to
 * order a given set of joins.
 * */
public class PlanCache {
  private HashMap<Set<LogicalJoinNode>, Vector<LogicalJoinNode>> bestOrders =
    new HashMap<Set<LogicalJoinNode>, Vector<LogicalJoinNode>>();

  private HashMap<Set<LogicalJoinNode>, Double> bestCosts =
    new HashMap<Set<LogicalJoinNode>, Double>();

  private HashMap<Set<LogicalJoinNode>, Integer> bestCardinalities =
    new HashMap<Set<LogicalJoinNode>, Integer>();
  
  /**
   * Add a new cost, cardinality and ordering for a particular join set.
   * Does not verify that the new cost is less than any previously added cost,
  ...
  /**
   * Find the best join order in the cache for the specified splan.
   *
