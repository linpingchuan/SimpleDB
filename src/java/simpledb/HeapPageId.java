...
public class HeapPageId implements PageId {
  ...
  /** Returns the table associated with this PageId. */
  public int getTableId() {
    return tableId;
  }

  /**
   * Returns the page number in the table getTableId() associated with
   * this PageId.
   */
  ...
  public boolean equals(Object o) {
    if (o != null && o instanceof HeapPageId) {
      ...
      return id.tableId == tableId && id.pgNo == pgNo;
    }
    return false;
  }

  /**
   * Returns a representation of this object as an array of integers, for
   * writing to disk.
   *
